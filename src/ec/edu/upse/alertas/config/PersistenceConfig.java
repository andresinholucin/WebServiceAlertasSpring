package ec.edu.upse.alertas.config;
...
@PropertySource({ "classpath:META-INF/persistence-config.properties" })
@ComponentScan({ "ec.edu.upse.alertas.modelo" })
@EnableJpaRepositories(basePackages = "ec.edu.upse.alertas.modelo")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "ec.edu.upse.alertas.modelo" });
